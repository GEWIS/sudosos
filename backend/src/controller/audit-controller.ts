...
export default class AuditController extends BaseController {
   ...
   * @param {string} entityType.query - enum:Invoice,SellerPayout,PayoutRequest,WriteOff,Transaction,Transfer,Product,Fine,FineHandoutEvent,PaymentRequest,InactiveAdministrativeCost,VoucherGroup - Filter on the kind of object that was mutated
