 ...
 * @property {string} entityType.required - enum:Invoice,SellerPayout,PayoutRequest,WriteOff,Transaction,Transfer,Product,Fine,FineHandoutEvent,PaymentRequest,InactiveAdministrativeCost,VoucherGroup - The kind of object that was mutated
